  ...
  class Model
    ...
    class OrmAdapter < ::OrmAdapter::Base
        ...
        def self.model_classes
          ObjectSpace.each_object(Class).to_a.select {|klass| klass.ancestors.include? Couchbase::Model }
        end
        ...
        def conditions_to_fields(conditions)
          conditions.inject({}) do |fields, (key, value)|
            if value.is_a?(Couchbase::Model) && klass.fields.keys.include?("#{key}_id")
